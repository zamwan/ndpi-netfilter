...
"SAP","GTP","uPnP","LLMNR","Remote_Scan","Spotify","WebM","H323","OpenVPN","NOE","CiscoVPN","TeamSpeak","Tor","Skinny","RTCP","RSYNC","Oracle","Corba","Ubuntu_ONE"
#endif
...
"sap","gtp","upnp","llmnr","remotescan","spotify","webm","h323","openvpn","noe","ciscovpn","teamspeak","tor","skinny","rtcp","rsync","oracle","corba","ubuntuone"
#endif
